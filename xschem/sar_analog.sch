...
F {}
E {}
C {ipin.sym} -200 -160 0 0 {name=p1 lab=dac_b[9:0]}
C {ipin.sym} -200 -120 0 0 {name=p2 lab=sample}
C {ipin.sym} -200 -80 0 0 {name=p3 lab=cmp_clk}
C {ipin.sym} -200 -40 0 0 {name=p4 lab=force_en}
...
C {iopin.sym} 0 -40 0 0 {name=p11 lab=vss}
